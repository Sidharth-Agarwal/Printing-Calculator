...
// import DieManagement from "./components/management/die/DieManagement"
// import MaterialManagement from "./components/management/material/MaterialManagement"
// import StandardRateManagement from "./components/management/standard-rate/StandardRateManagement"
...
import MaterialManagement from "./components/management/material/MaterialManagement"
import StandardRateManagement from "./components/management/standard-rate/StandardRateManagement"
import BillingFormSinglePage from "./components/billing-form/BillingFormSinglePage";
import Header from "./components/Header";
import Login from "./components/Login/login";
import "./styles/tailwind.css";
  ...
  return (
    <div>
      ...
      <main className="container mx-auto p-6">
        <Routes>
          <Route path="/" element={<Login />} />
          <Route path="/new-bill" element={<BillingFormSinglePage />} />
          <Route path="/material-stock/paper-db" element={<PaperManagement />} />
          <Route path="/material-stock/material-db" element={<MaterialManagement />} />
          <Route path="/material-stock/dies-db" element={<DieManagement />} />
          <Route path="/material-stock/standard-rates-db" element={<StandardRateManagement />} />
