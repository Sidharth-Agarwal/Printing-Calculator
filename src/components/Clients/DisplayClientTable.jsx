                  ...
                  <td className="px-3 py-3" onClick={(e) => e.stopPropagation()}>
                    <div className="flex items-center space-x-1">
                      ...
                      <button
                        ...
                        title={expandedRows[client.id] ? "Show Less" : "Show More"}
                      >
                        <svg className={`w-4 h-4 transition-transform ${expandedRows[client.id] ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
