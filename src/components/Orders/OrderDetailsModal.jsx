...
// import { doc, updateDoc } from 'firebase/firestore';
// import { db } from '../../firebaseConfig';
// import StyledJobTicket from '../components/StyledJobTicket';
// import StyledInvoice from '../components/StyledInvoice';
...
//     const opt = {
//       margin:       [10, 10, 10, 10],
//       filename:     `${order.clientName}_${activeView === 'ticket' ? 'Job_Ticket' : 'Invoice'}_${new Date().toISOString().split('T')[0]}.pdf`,
...
//             {(activeView === 'ticket' || activeView === 'invoice') && (
//               <button
//                 onClick={generatePDF}
