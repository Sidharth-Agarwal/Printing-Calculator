...
// //         // Set default markup if available
...
// //           {/* Markup Selection Field - Always expanded but no editing allowed */}
// //           <div className="mt-6 bg-blue-50 p-4 rounded-md border border-blue-200">
...
//   // Initialize calculations with current values
//   useEffect(() => {
...
//       // Add the markup percentage and misc charge used for calculations
