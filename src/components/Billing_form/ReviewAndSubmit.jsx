...
//             <div 
//               className="flex justify-between items-center cursor-pointer mb-2"
//               onClick={() => toggleSection('miscCharge')}
//             >
//               <h3 className="text-md font-semibold text-gray-700">Miscellaneous Charge</h3>
//               <span className={`transform transition-transform ${expandedSections.miscCharge ? 'rotate-180' : ''}`}>
//                 ▼
//               </span>
//             </div>
            
//             {(expandedSections.miscCharge || !singlePageMode) && (
//               <div className="mt-2">
//                 <div className="flex flex-col md:flex-row md:items-center gap-4">
//                   <div className="w-full md:w-1/3 flex items-center gap-2">
