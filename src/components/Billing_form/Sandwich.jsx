...
//   // Effect to reset color details when the number of colors changes
//   useEffect(() => {
//     setData((prev) => ({
//       ...prev,
//       colorDetails: Array.from({ length: data.noOfColors }, () => ({
//         plateType: "",
//         mrType: "",
//         inkType: "",
//       })),
...
//   // Effect to reset foil details when FS type changes
//   useEffect(() => {
//     if (data.fsType) {
//       const foilCount = data.fsType === "FS1" ? 1 : data.fsType === "FS2" ? 2 : 3;
//       setData((prev) => ({
//         ...prev,
//         foilDetails: Array.from({ length: foilCount }, () => ({
//           foilType: "",
//           blockType: "",
//           mrType: "",
//         })),
...
//       {/* Sandwich Toggle */}
//       <div className="space-y-2">
//         <label className="block font-medium text-gray-700">Is Sandwich being used?</label>
...
//               name="isSandwichUsed"
//               value={true}
//               checked={data.isSandwichUsed === true}
//               onChange={() => setData((prev) => ({ ...prev, isSandwichUsed: true }))}
//               className="mr-2"
//             />
//             Yes
//           </label>
...
//               name="isSandwichUsed"
//               value={false}
//               checked={data.isSandwichUsed === false}
//               onChange={() => setData((prev) => ({ ...prev, isSandwichUsed: false }))}
//               className="mr-2"
//             />
//             No
//           </label>
