...
//     paperName: "",
//     dieSelection: "",
//     dieCode: "", // Updated to store the dieCode from the die database
...
//   // Updates the dieCode and other die details when a die is selected
//   const handleDieSelect = (die) => {
//     setData((prev) => ({
//       ...prev,
//       dieSelection: die.dieName, // Optionally include dieName if needed
//       dieCode: die.dieCode, // Populate the Die Number field with dieCode
...
//               type="text"
//               name="dieCode"
//               value={data.dieCode} // Populated with dieCode from die management
//               readOnly
