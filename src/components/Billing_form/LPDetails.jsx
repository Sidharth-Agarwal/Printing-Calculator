...
//     colorDetails: initialData?.colorDetails || [], // Holds plate size, ink type, plate type, MR type for each color
//   });
...
//       plateSizeType: data.colorDetails[index]?.plateSizeType || "",
//       plateDimensions: data.colorDetails[index]?.plateDimensions || {
//         length: "",
//         breadth: "",
//       },
...
//                   <select
//                     value={data.colorDetails[index]?.plateSizeType || ""}
//                     onChange={(e) =>
...
//                 {data.colorDetails[index]?.plateSizeType === "Manual" && (
...
//                       value={
//                         data.colorDetails[index]?.plateDimensions?.length || ""
//                       }
//                       onChange={(e) =>
//                         handleColorDetailsChange(index, "plateDimensions", {
//                           ...data.colorDetails[index]?.plateDimensions,
...
//                       value={
//                         data.colorDetails[index]?.plateDimensions?.breadth || ""
//                       }
//                       onChange={(e) =>
//                         handleColorDetailsChange(index, "plateDimensions", {
//                           ...data.colorDetails[index]?.plateDimensions,
