...
//           ? [
//               {
//                 plateSizeType: "Auto", // Auto-select "Auto"
//                 plateDimensions: { 
//                   length: dieSize.length ? inchesToCm(dieSize.length).toFixed(2) : "", 
//                   breadth: dieSize.breadth ? inchesToCm(dieSize.breadth).toFixed(2) : "" 
//                 },
//                 pantoneType: "",
//                 plateType: "Polymer Plate", // Auto-select "Polymer Plate"
//                 mrType: "Simple", // Auto-select "Simple"
//               },
//             ]
//           : [],
//       },
...
//                   <div className="flex flex-wrap gap-4 text-sm">
//                     {/* Plate Size Type - Always Auto */}
//                     <div className="flex-1">
//                       <div className="mb-1">Plate Size (cm):</div>
//                       <div className="border rounded-md p-2 w-full bg-gray-100">
//                         Auto (Die Size)
//                       </div>
//                       <input
//                         type="hidden"
//                         name={`plateSizeType_${index}`}
//                         value="Auto"
//                       />
//                     </div>

//                     {/* Plate Dimensions - Read-only */}
//                     <div className="flex flex-wrap gap-4 flex-1">
//                       <div className="flex-1">
//                         <label htmlFor={`length_${index}`} className="block mb-1">
//                           Length:
...
//                     {/* Plate Type - Always Polymer Plate */}
//                     <div className="flex-1">
//                       <div className="mb-1">Plate Type:</div>
//                       <div className="border rounded-md p-2 w-full bg-gray-100">
//                         Polymer Plate
...
//                       <input
//                         type="hidden"
//                         name={`plateType_${index}`}
//                         value="Polymer Plate"
//                       />
//                     </div>

//                     {/* MR Type - Always Simple */}
//                     <div className="flex-1">
//                       <div className="mb-1">MR Type:</div>
//                       <div className="border rounded-md p-2 w-full bg-gray-100">
//                         Simple
