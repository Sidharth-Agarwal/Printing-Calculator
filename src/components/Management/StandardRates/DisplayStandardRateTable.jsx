...
const DisplayStandardRateTable = ({ rates, onDelete, onEdit }) => {
  ...
  // Sort rates based on sort field and direction
    ...
    <div className="bg-white rounded-lg overflow-hidden">
      ...
      <div className="pb-4 flex flex-col md:flex-row justify-between items-center gap-3">
        ...
        <div className="text-sm text-gray-600">
          {sortedRates.length} {sortedRates.length === 1 ? 'rate' : 'rates'} found
        </div>
      </div>
      ...
      {sortedRates.length > 0 ? (
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-100">
              <tr>
                ...
                <SortableHeader field="finalRate" label="Final Rate (INR)" />
        ...
        <div className="bg-white p-8 text-center text-gray-500">
          ...
          {searchTerm ? (
            <>
              <p className="text-lg font-medium">No rates match your search</p>
            ...
            <>
              <p className="text-lg font-medium">No standard rates found</p>
              <p className="mt-1">Add your first rate to get started</p>
            </>
          )}
        </div>
      )}
