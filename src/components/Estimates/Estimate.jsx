...
// const Estimate = ({ estimate, estimateNumber, movedToOrdersEstimateId, setMovedToOrders, estimates }) => {
...
//       console.log(`Successfully moved estimate ${estimate.id} to orders and updated the group.`);
//     } catch (error) {
...
//     try {
//       // Immediately update local state to remove "Move to Orders" button
//       const updatedEstimates = estimates.map((est) => ({
//         ...est,
...
//       setEstimatesData((prevData) => ({
//         ...prevData,
//         [groupKey]: updatedEstimates, // Update estimates for the group
//       }));
...
//       console.log("Successfully canceled all estimates in the group.");
//     } catch (error) {
