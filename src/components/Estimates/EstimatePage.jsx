...
//   const [ordersData, setOrdersData] = useState({}); // Track moved-to-orders estimates per group
...
//         // Group estimates by clientName and projectName
//         const groupedData = data.reduce((acc, estimate) => {
//           const { clientName, projectName } = estimate;
//           const groupKey = `${clientName}-${projectName}`;
//           if (!acc[groupKey]) acc[groupKey] = [];
...
//       // Check if the query matches clientName, projectName, jobType, or quantity
//       const filteredEstimates = estimates.filter((estimate) => {
//         const jobType = estimate?.jobDetails?.jobType?.toLowerCase() || "";
//         const quantity = estimate?.jobDetails?.quantity?.toString() || "";
//         return (
...
//               projectName={projectName}
//               estimates={estimates}
//               ordersData={ordersData} // Pass orders data
//               setOrdersData={setOrdersData} // Function to update orders data
//             />
//           );
//         })}
//       </div>
