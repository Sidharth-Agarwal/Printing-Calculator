...
const EstimatesPage = () => {
  ...
  // UPDATED: Toggle multi-select mode
  ...
  // UPDATED: Toggle selection for a single estimate
  ...
  // UPDATED: Select all estimates for current version
  ...
  // NEW: Toggle showing all versions
  ...
  // UPDATED: Select a version without clearing selections
  const selectVersion = (clientId, versionId) => {
    ...
    // Don't clear selections when changing versions anymore
  };
            ...
            <div key={client.id} className={`bg-white rounded-lg shadow-sm border ${!client.isActive ? 'border-red-300 border-l-4' : 'border-gray-200'} overflow-hidden`}>
              ...
              {expandedClientId === client.id && (
                <div className="border-t border-gray-200 bg-white">
                  ...
                  {/* NEW: Show all versions at once in a tabbed layout */}
                  {showAllVersions && (
                    <div className="p-4">
                      <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center gap-2">
