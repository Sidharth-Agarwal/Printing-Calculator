...
const EstimatesPage = () => {
  ...
  // UPDATED: Handle moving estimate to orders or escrow with serial number generation
  ...
  // UPDATED: Handle moving multiple estimates to orders or escrow with serial numbers
