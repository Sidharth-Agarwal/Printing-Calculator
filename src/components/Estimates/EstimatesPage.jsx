...
// // import { collection, getDocs, doc, updateDoc, addDoc, where, getDoc, query } from "firebase/firestore";
...
// // import { createLoyaltyTierChangeNotification } from "../../utils/loyaltyUtils";
...
// //   // Handle moving estimate to orders - Updated to handle loyalty
...
// //                 // Set UI notification for admin users
...
// //       // Navigate to orders page if no loyalty notification
// //       if (!loyaltyUpdate?.tierChanged) {
// //         navigate('/orders');
// //       }
// //     } catch (error) {
...
// //               <h3 className="text-sm font-medium text-green-800">Loyalty Tier Upgraded!</h3>
...
// //                   New discount: <span className="font-medium">{loyaltyNotification.newDiscount}%</span>
// //                 </p>
// //               </div>
// //               <div className="mt-4">
...
// //                   >
// //                     Dismiss and continue to orders
// //                   </button>
// //                 </div>
// //               </div>
// //             </div>
...
//   // Handle deleting an estimate and its related notifications
...
//       console.log("Successfully deleted estimate and related notifications");
//     } catch (error) {
...
//                             <button
//                               onClick={() => {
//                                 // Get the first estimate of the current version to delete
//                                 const estimateToDelete = client.versions.get(selectedVersions[client.id])?.estimates[0];
//                                 if (estimateToDelete) {
//                                   handleDeleteEstimate(estimateToDelete);
//                                 }
//                               }}
//                               className="px-3 py-1 rounded text-xs bg-red-50 text-red-600 hover:bg-red-100 flex items-center gap-1"
//                             >
//                               <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
